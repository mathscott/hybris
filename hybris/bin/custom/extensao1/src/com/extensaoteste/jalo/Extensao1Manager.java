 ...
 */
package com.extensaoteste.jalo;
...
import com.extensaoteste.constants.Extensao1Constants;
 ...
 */
public class Extensao1Manager extends GeneratedExtensao1Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Extensao1Manager.class.getName());
	 ...
	 */
	public static Extensao1Manager getInstance()
	{
		return (Extensao1Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Extensao1Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public Extensao1Manager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Extensao1Manager called.");
		}
	}
