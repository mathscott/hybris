 ...
 */
package com.testebackoffice.jalo;
...
import com.testebackoffice.constants.ExtensaotestebackofficeConstants;
 ...
 */
public class ExtensaotestebackofficeManager extends GeneratedExtensaotestebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ExtensaotestebackofficeManager.class.getName());
	 ...
	 */
	public static ExtensaotestebackofficeManager getInstance()
	{
		return (ExtensaotestebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ExtensaotestebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ExtensaotestebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ExtensaotestebackofficeManager called.");
		}
	}
