...
java -classpath "${SCRIPT_PATH}/libs/commons-cli-1.2.jar:${SCRIPT_PATH}/libs/commons-lang-2.6.jar:${SCRIPT_PATH}/libs/groovy-all-2.4.10.jar:${SCRIPT_PATH}/libs/installer-6.7.0.3.jar" de.hybris.installer.CmdHandler "$@"
